...
const Navbar = () => {
    return (
        ...
        <div className="navbar box-shadow mb-4">
                ...
                <nav className="main-nav flex justify-between items-center py-5">
                    <div className="site-logo">
                        <a href="" className="flex gap-3 items-center">
                            ...
                            <h1 className="font-bold text-2xl">Pop and Convert <span className="text-blue-600">PRO</span></h1>
                        </a>
                    </div>
                    <ul className="icons flex gap-5">
                        <li>
                            <a href="">
                                <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="1.00037" y="0.5" width="43" height="43" rx="21.5" fill="#DDE8FF" />
                                    <path d="M22.5003 30.3332C27.1027 30.3332 30.8337 26.6022 30.8337 21.9998C30.8337 17.3975 27.1027 13.6665 22.5003 13.6665C17.898 13.6665 14.167 17.3975 14.167 21.9998C14.167 26.6022 17.898 30.3332 22.5003 30.3332Z" stroke="#2F65D5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M14.167 22H30.8337" stroke="#2F65D5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M22.5003 13.6665C24.5847 15.9485 25.7693 18.9099 25.8337 21.9998C25.7693 25.0898 24.5847 28.0512 22.5003 30.3332C20.4159 28.0512 19.2314 25.0898 19.167 21.9998C19.2314 18.9099 20.4159 15.9485 22.5003 13.6665V13.6665Z" stroke="#2F65D5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    <rect x="1.00037" y="0.5" width="43" height="43" rx="21.5" stroke="#2F65D5" />
                                </svg>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="">
                                <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.8337 13.6665H23.3337L29.1671 19.4998V30.3332H15.8337V13.6665Z" stroke="#3C434A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M23.3337 13.6665V19.4998H29.1671" stroke="#3C434A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M19.167 23.6665H25.8337" stroke="#3C434A" strokeWidth="2" strokeLinecap="round" />
                                    <path d="M19.167 27H22.5003" stroke="#3C434A" strokeWidth="2" strokeLinecap="round" />
                                    <rect x="1.00037" y="0.5" width="43" height="43" rx="21.5" stroke="#E0E9EC" />
                                </svg>
                            </a>
                        </li>
